...
! Данные **демо**нстрационные. Нужно заменить функцию '*cursArr*' в *js.min.js* на закомментированный код (он там же) и разместить файлы на сервер с PHP (для выполнения '*curs.php*'). Рабочий вариант: http://cc.rewww.ru/
